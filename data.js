 ...
 * Se ONBOARDING-anteckningar i chatten för fullständig genomgång.
 */
...
const LIFT_ORDER = Object.keys(LIFTS);
...
const VARIATION_OFFSET = -0.10;
const CYCLE_LENGTH = WEEK_MAIN_INTENSITY.length; // 21 veckor, upprepas därefter
...
const DEFAULT_THRESHOLDS = { lower: 4, upper: 6, increasePct: 0.02, decreasePct: -0.05 };
...
function intensityFor(liftKey, absoluteWeek) {
  const week = effectiveWeek(absoluteWeek);
...
function computeWeight(max, pct, rounding) {
